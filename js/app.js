(() => {
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (targetElement.closest(".filter__button-clear")) {
            const clearButton = targetElement.closest(".filter__button-clear");
            filterBlockClear(clearButton);
        }
    }));
    let script_button = document.querySelectorAll(".aside-acc__item");
    let content_inside = document.querySelectorAll(".block-acc");
    Array.from(script_button).forEach((function(buttonArray, i) {
        buttonArray.addEventListener("click", (function() {
            Array.from(script_button).forEach((buttonAll => buttonAll.classList.remove("_active")));
            Array.from(content_inside).forEach((content_insideAll => content_insideAll.classList.remove("_active")));
            script_button[i].classList.add("_active");
            content_inside[i].classList.add("_active");
        }));
    }));
    function filterClearShow(targetElement) {
        const filterBlock = targetElement.closest(".filter__block");
        const filterClear = filterBlock.querySelector(".filter__button-clear");
        setTimeout((() => {
